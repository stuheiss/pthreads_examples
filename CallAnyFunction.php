...
$future = Caller::call(function (...$params) {
    // cant use $params as array of strings :-(
    //printf("and how about this: %s, %s %s %s %s!\n", ...$params);
    // convert array of Volatile to array of strings :-)
    $params = array_values((array)$params[0][0]);
    return sprintf("and how about this: %s, %s %s %s %s!\n", ...$params);
